...
The original design documents live in `notes/`:

- `vision.md` — intent, scope, and the role of the cmux/terax references.
- `functional-spec.md` — UX details, persistence semantics, shortcuts.
- `technical-spec.md` — integration approach, IPC, schema, packaging
  (§11–§14 cover the roadmap items).
